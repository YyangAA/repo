...
def _draw_confusion_matrix(ax, cm, labels, title, auc_val=None, cmap='Blues'):
    """
    ...
    参数:
        ...
        labels:   类别标签列表
        title:    子图标题
        auc_val:  AUC 值 (float 或 None)，标注在标题下方
        cmap:     颜色方案
    """
...
def render_confusion_matrices(region_results, output_dir):
    ...
    布局:
      Row 0: 4 个二分类混淆矩阵 (Normal vs Damaged, Blues)
      Row 1: 4 个三分类混淆矩阵 (G0/G1/G2, Oranges)
    """
